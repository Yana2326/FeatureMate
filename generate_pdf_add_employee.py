"""
Render output/add-employee/article.html → article.pdf via Playwright.
Reuses the print stylesheet pattern from generate_pdf.py — same A4 layout,
same isolated headless Chromium (no CDP attach to user's Chrome).
"""
...
HTML_PATH = HERE / "output/add-employee/article.html"
PDF_PATH  = HERE / "output/add-employee/article.pdf"
